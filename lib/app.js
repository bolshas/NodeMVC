function App() {
    ...
    this.credentials = {
        key: this.fs.readFileSync('./ssl/privatekey.pem').toString(), 
        cert: this.fs.readFileSync('./ssl/bolshas_com.crt').toString()
    }
...
App.prototype.start = function (port) {
    ...
    this.server = require('https').createServer(this.credentials, function (request, response) {
